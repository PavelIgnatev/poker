...
const filter = (ruleLevel, tournament, isGetTournaments = false) => {
  const ability =
    !tournament["@ability"] || tournament["@ability"] === "-" ? 0 : tournament["@ability"];
