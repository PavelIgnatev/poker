...
export const postConfig = failuresDomain.createEffect(async (config: defaultConfigModel) => {
...
export const deleteConfig = failuresDomain.createEffect(async (alias: string) => {
